    ...
    <nav class="navbar navbar-default navbar-fixed-top navbar-inverse">
      <div class="container-fluid">
        ...
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.php"><img alt="Brand" src="img/logo ckencio library.png" style="width: 118px;margin-top: -7px;margin-left: -10px;"></a>
        </div>
          ...
          <ul class="nav navbar-nav navbar-right">
              <?php
                  if(isset($_SESSION['user']))
                    {
                      echo'
                    <li><a href="cart.php" class="btn btn-md"><span class="glyphicon glyphicon-shopping-cart">Carrito</span></a></li>
                    <li><a href="destroy.php" class="btn btn-md"> <span class="glyphicon glyphicon-log-out">CerrarSesion</span></a></li>
                         ';
                    }
               ?>
          </ul>
    ...
    echo '<div class="container-fluid" id="books">
        <div class="row">
          <div class="col-xs-12 text-center" id="heading">
                 <h2 style="color:#D67B22;text-transform:uppercase;margin-bottom:0px;"> '. $author .' LIBROS </h2>
           </div>
        </div>      
        <div class="container fluid">
             <div class="row">
